...
public class Passenger 
{
	...
	public Passenger(int pax_id, int customer_id, int package_id, int pax_amount, String pax_birthdate,
			String pax_name, String pax_type, int booking_id) {
		super();
		this.pax_id = pax_id;
		this.customer_id = customer_id;
		this.package_id = package_id;
	...
	public String toString() {
		return "Passenger [pax_id=" + pax_id + ", customer_id=" + customer_id + ", package_id=" + package_id
				+ ", pax_amount=" + pax_amount + ", pax_birthdate=" + pax_birthdate + ", pax_name=" + pax_name
				+ ", pax_type=" + pax_type + ", booking_id=" + booking_id + "]";
	}
}
